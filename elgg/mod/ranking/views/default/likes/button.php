...
if (elgg_is_logged_in() && $vars['entity']->canAnnotate(0, 'likes')) {
	if (!elgg_annotation_exists($guid, 'likes')) {
		...
		$params = array(
			'href' => $url,
			'text' => '<img src="http://www.lecom.dcc.ufmg.br/shareit/elgg/mod/likes/graphics/sponsor.png">',
		...
		$params = array(
			'href' => $url,
			'text' => '<img src="http://www.lecom.dcc.ufmg.br/shareit/elgg/mod/likes/graphics/unsponsor.png">',
