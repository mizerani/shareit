	...
	<table>
		<tr>
			<td>
				...
				<p class = "switch" id="show_profile" align = "center">Mostrar Perfil<br></p>
				<p class = "switch" id="show_initial" style="display:none;" align = "center">Página inicial<br></p>
				<a href="/shareit/empresa/cadastro.php" align = "center">Cadastra Empresa<br></a>
...
<!--Better ranked Ideas-->
	<div class = 'best' align = "center">
		<? 
			...
			$ideas_all = mysql_query("	SELECT  texto, idea.id, idea.data, count(like_idea.idea) as n_spons, user.nome as name
					FROM  idea JOIN like_idea ON idea.id = like_idea.idea JOIN user ON idea.autor = user.id
	...
	<div class = 'mine' align = "center">
		<? 
			...
			$ideas = mysql_query("	SELECT  texto, idea.id, idea.data, count(like_idea.idea) as n_spons, user.nome as name
					FROM  idea JOIN like_idea ON idea.id = like_idea.idea JOIN user ON idea.autor = user.id
