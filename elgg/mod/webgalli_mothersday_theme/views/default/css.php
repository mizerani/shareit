...
/* elgg open source		blue 			#7d450b */
/* elgg open source		dark blue 		#7d450b */
...
body {
	...
	background:#7d450b url('<?php echo $vars['url']; ?>mod/webgalli_mothersday_theme/graphics/body_bg1.jpg') repeat-x;
...
#layout_canvas {
	...
	background:url('<?php echo $vars['url']; ?>mod/webgalli_mothersday_theme/graphics/contentbg.png');border-bottom:1px solid #cccccc;
...
#two_column_left_sidebar {
	...
	min-height:360px;
	float:left;
	background:url('<?php echo $vars['url']; ?>mod/webgalli_mothersday_theme/graphics/contentbg.png');padding:0px;
	-webkit-border-radius: 8px; 
	-moz-border-radius: 8px;
...
#layout_spotlight {
	...
	color: #999999;
	border :1px solid #cccccc;
	background:url('<?php echo $vars['url']; ?>mod/webgalli_mothersday_theme/graphics/contentbg.png');
}
#wrapper_spotlight {
	margin:0;
	padding:0;
...
*************************************** */
#elgg_topbar {
	background: transparent url(<?php echo $vars['url']; ?>mod/webgalli_mothersday_theme/graphics/page_header.jpg) repeat-x top left;
    color:#000000;
	position:relative;
	width:100%;
	margin: auto;
...
*+html #elgg_topbar_container_left a.privatemessages_new { background-position: left -18px; } 
	...
	color:#eeeeee;
	margin:0 5px 0 0;
	background:transparent url(<?php echo $vars['url']; ?>mod/webgalli_mothersday_theme/graphics/elgg_toolbar_logout.png) no-repeat top right;padding:0 21px 0 0;
	display:block;
	height:20px;
}
#elgg_topbar_container_reg {
	...
	color:#eeeeee;
	margin:0 5px 0 0;
	background:transparent url(<?php echo $vars['url']; ?>mod/webgalli_mothersday_theme/graphics/elgg_toolbar_reg.png) no-repeat top right;padding:0 21px 0 0;
	display:block;
	height:20px;
}
/* IE6 fix */
...
#owner_block_submenu ul li.selected a {
	color:#DEDEDE;
	background: url(<?php echo $vars['url']; ?>mod/webgalli_mothersday_theme/graphics/owner_block_menu_arrow.gif) no-repeat left 6px;
	padding-left:10px;
}
...
div.ajax_loader {
	background: white url(<?php echo $vars['url']; ?>mod/webgalli_mothersday_theme/graphics/ajax_loader.gif) no-repeat center 30px;
	width:auto;
	height:100px;
	margin:0 10px 0 10px;
	-webkit-border-radius: 8px; 
