...
$spotlightcontent = get_plugin_setting('spotlightcontent', 'theme_seashells');
if ($spotlightcontent == '') {
...
set_plugin_setting('spotlightcontent',$spotlightcontent, 'theme_seashells');
}
?>

<div id="spotlight_table">
	<?php echo $spotlightcontent ?> 
