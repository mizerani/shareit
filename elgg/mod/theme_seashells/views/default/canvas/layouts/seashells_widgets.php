...
<table cellspacing="0" id="widget_table" align="center">
	<tr>
...
if ($owner && $owner->canEdit()) {
 if (get_loggedin_userid() == page_owner()) { ?>
        ...
        <a href="#edit" class="toggle_customise_edit_panel"><?php echo(elgg_echo('dashboard:configure'));  ?></a>
	...
	<div id="customise_editpanel_rhs">
                    ...
                    <table class="draggable_widget" cellspacing="0">
                    	<tr>
                            ...
                            <td width="17px" align="right">
                            	<a href="#edit"><img src="<?php echo $vars['url']; ?>_graphics/spacer.gif" width="14" height="14" class="more_info" /></a>
                            </td>
                            <td width="17px" align="right">
                            	<a href="#edit"><img src="<?php echo $vars['url']; ?>_graphics/spacer.gif" width="15" height="15" class="drag_handle" /></a>
                            </td>
                        </tr>
                    </table>
                 <?php } ?><br /><!-- bit of space at the bottom of the widget gallery --> 
           </div><!-- /#customise_editpanel_rhs --> 
        </div><!-- /#widget_picker_gallery -->
		
        <div class="customise_editpanel_instructions"> 
        	<a name="edit"><h2><?php echo elgg_echo('widgets:add');  ?></h2></a> 
        ...
        <div id="customise_page_view">
            	...
            	<tr>
                	<td colspan="3" align="left" valign="top">
                    	<?php if(get_context() == "profile"){ ?>
                            ...
                            <div id="profile_box_widgets"><p><small><?php echo elgg_echo('widgets:position:fixed');  ?></small></p></div>
                        <?php } ?>
                    </td>
                </tr>
                <tr>
               		<td>
                        ...
                        <div id="leftcolumn_widgets">
                            ...
                            <table class="draggable_widget" cellspacing="0">
                            	<tr>
                                	<td width="149px">
		                            	<h3><?php echo $widgettypes[$widget->handler]->name; ?>
       	...
       	<form action="<?php echo	$vars['url'];  ?>action/widgets/reorder" method="post">
            ...
            <?php $ts = time();	$token = generate_action_token($ts); ?>
