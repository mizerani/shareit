...
if (elgg_is_active_plugin('search')) {
    echo "<h3>".elgg_echo('river_activity_3C:searchplugin')."</h3>";
    echo '<div class="admin_settings">'.elgg_echo('river_activity_3C:show_searchplugin').'  :  ';
    echo elgg_view('input/dropdown', array(
            'name' => 'params[show_searchplugin]',
            'options_values' => array(
                    'no' => elgg_echo('river_activity_3C:no'),
                    'yes' => elgg_echo('river_activity_3C:yes')
            ),
            'value' => $vars['entity']->show_searchplugin,
            ));
    echo '<br />'.elgg_echo('river_activity_3C:pos').'  :  ';
    echo elgg_view('input/dropdown', array(
            'name' => 'params[searchplugin_pos]',
            'options_values' => array(
                    'right' => elgg_echo('river_activity_3C:right'),
                    'left' => elgg_echo('river_activity_3C:left')
            ),
            'value' => $vars['entity']->searchplugin_pos,
            ));
    echo "<br />".elgg_echo('river_activity_3C:pir')." : ";
    echo elgg_view('input/text', array(
            'name' => "params[searchplugin_pir]",
            'value' => $vars['entity']->searchplugin_pir,
            ));
    echo "</div>";
}    

//Show Activity/*
echo "<h3>".elgg_echo('river_activity_3C:activity')."</h3>";
    echo '<div class="admin_settings">'.elgg_echo('river_activity_3C:show_activity').'  :  ';
    echo elgg_view('input/dropdown', array(
            'name' => 'params[show_activity]',
            'options_values' => array(
                    'no' => elgg_echo('river_activity_3C:no'),
                    'yes' => elgg_echo('river_activity_3C:yes')
            ),
            'value' => $vars['entity']->show_activity,
            ));
    echo '<br />'.elgg_echo('river_activity_3C:pos').'  :  ';
    echo elgg_view('input/dropdown', array(
            'name' => 'params[activity_pos]',
            'options_values' => array(
                    'right' => elgg_echo('river_activity_3C:right'),
                    'left' => elgg_echo('river_activity_3C:left')
            ),
            'value' => $vars['entity']->activity_pos,
            ));
    echo "<br />".elgg_echo('river_activity_3C:pir')." : ";
    echo elgg_view('input/text', array(
            'name' => "params[activity_pir]",
            'value' => $vars['entity']->activity_pir,
            ));
    echo "</div>";
